...
# Filename:     plot1.R                                                        #
#                                                                              #
# Description:  File containing the R language code that produces the first    #
...
#-------------------------------------------------------------------------------
#Step 4:
#Finally, we proceed to the actual realization of the plot. It is a histogram
#of the "Global_active_power" variable that will be stored in a png file called
#"plot1.png":

#We open a PNG device and we configure it with the dimensions requested:
png("plot1.png", width = 480, height = 480)

#We create the desired histogram and we send it to the file:
hist(as.numeric(as.character(interval$Global_active_power)), col = "red", 
